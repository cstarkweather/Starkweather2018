function params = SimulateOdorB(simulation_index,Weber_fraction,jitter,belief_impaired,weights,learning_rate)
...
save(strcat('B_results',num2str(simulation_index),'.mat'))
