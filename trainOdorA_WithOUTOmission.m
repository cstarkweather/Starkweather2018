function [weights] = trainOdorA_WithOUTOmission(training_session,Weber_fraction,jitter,learning_rate,w)
flatten_belief=500;
...
save(strcat('OdorA_100%_results_',num2str(training_session),'.mat'))
