function params = SimulateOdorA_withOmission(simulation_index,Weber_fraction,jitter,belief_impaired,weights,learning_rate)
...
save(strcat('A90_results',num2str(simulation_index),'.mat'))
